...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://gspbackend.onrender.com/api/send-email', dataToSubmit);
    ...
    <div className="col-sm-12 col-md-6 col-lg-5 contact-section-1">
     ...
     <div className="contact-us">
      ...
      <div className="contact-details col-10">
        <a  href ="/"className="p-text">Delhi, 01, 12563</a>
      ...
      <div className="contact-details col-10">
      <a href="https://wa.me/918581869783/?text=Hi!%20I'm%20interested%20to%20know%20more." className='p-text' target="_blank" rel="noreferrer">WhatsApp</a>
    ...
    {/* <form onClick={handleSubmit}>
      <div className="formInput">
        <div className="contact-form row">
         <div className="col-12 col-sm-12 form_input">
               <label className="form-label"style={{marginTop:"10px"}}>Name</label>
                 <input type="text" placeholder='Enter your Name' value={name} onChange={(e) => setName(e.target.value)} onBlur={handleFocus}
                 onFocus={() => email === setFocused(true)}
                     focused={focused.toString()} />           
          </div>
          <div className="col-12 col-sm-12 form_input">
               <label className="form-label"style={{marginTop:"10px"}}>Email</label>
                 <input type="email" placeholder='Enter your Email' value={email} onChange={(e) => setEmail(e.target.value)} onBlur={handleFocus}
                 onFocus={() => email === setFocused(true)}
                     focused={focused.toString()} />           
          </div>
          <div className="col-12 col-sm-12 form_input">
               <label className="form-label" style={{marginTop:"10px"}}>Message</label>
                  <text type="email" placeholder='Enter your Email' value={email} onChange={(e) => setEmail(e.target.value)} onBlur={handleFocus}
                 onFocus={() => email === setFocused(true)}
                     focused={focused.toString()} />  
                     <textarea name="" id="" cols="30" rows="5" placeholder='Enter your Message...' value={message}onChange={(e) => setMessage(e.target.value)} onBlur={handleFocus}
                     onFocus={() => message === setFocused(true)} focused={focused.toString()}></textarea>          
          </div>
          <div className="col-12 col-sm-12">
          <ReCAPTCHA  className='mt-3 ' sitekey='6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI' onChange={onChange}/>
            <button className="form_button mt-3" style={{marginTop:"-30px"}} disabled={!verified}>Send...</button>
          </div>
        </div>
      ...
      <ReCAPTCHA  className='mt-3 ' sitekey='6LchoMklAAAAAK2JZE7l0_fSqIkz97z5gD4DzidR' secretKey='6LchoMklAAAAAFFUKlCGlMnjFvrdmi06v_1R8qHm' onExpired={() => setRecaptchaValue('')}
