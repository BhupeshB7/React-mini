...
function ForgotPassword() {
  ...
  const handleEmailSubmit = async (event) => {
    ...
    try {
      await axios.post('https://gspbackend.onrender.com/api/auth/forgot-password', { email });
      setIsEmailSent(true);
  ...
  const handleOtpSubmit = async (event) => {
    ...
    try {
      await axios.post('https://gspbackend.onrender.com/api/auth/reset-password', { email, otp, newPassword });
