...
const ProfileUpdate = () => {
  ...
  const [profileData, setProfileData] = useState({ name: '', bio: '', mobile: '', email: '', address:'', accountNo:'', ifscCode:'', GPay:''});
...
const navigate = useNavigate();
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('https://gspbackend.onrender.com/api/users/profileUpdate', profileData, {
        headers: {
